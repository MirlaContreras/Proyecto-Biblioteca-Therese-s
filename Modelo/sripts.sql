...
/* TABLA 5: LISTA DESEADOS */
CREATE TABLE listaDeados(
	idListaDeseados INT AUTO_INCREMENT PRIMARY KEY,
	idLibros INT NOT NULL,
	idUsuarios INT NOT NULL,
	FOREIGN KEY(idLibros) REFERENCES libros(idLibros)
	ON DELETE CASCADE ON UPDATE CASCADE,
...
ADD fotoPerfil VARCHAR(255) DEFAULT NULL AFTER apellidoUsuarios;